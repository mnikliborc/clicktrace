...
public class SessionPropertiesWriter extends SessionPropertiesIO {
	...
	public void saveShotDescription(ScreenShot shot) {
		saveSessionProperty(shot.getFilename() + SessionManager.PROP_SUFFIX_DESCRIPTION,
				shot.getDescription());
	}
	...
	public void saveShotClicks(String shotFilename, List<Click> clicks) {
		if (!clicks.isEmpty()) {
			saveSessionProperty(shotFilename + SessionManager.PROP_SUFFIX_CLICKS,
					Click.getString(clicks));
		}
	}
